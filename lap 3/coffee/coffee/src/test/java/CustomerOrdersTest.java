...
class CustomerOrdersTest {
    ...
    void testTeaNoSugar() {
        ...
        assertEquals(expectedMessage, actualMessage, "Doit retourner un message qui contient 1 tea, 0  sugar and 0 stick");
    }
    ...
    void testCoffeeNoSugar() {
        ...
        assertEquals(expectedMessage, actualMessage, "Doit retourner un message qui contient 1  (coffee), 0  (sugar) et 0  (stick)");
    }
    ...
    void testTeaOneSugar() {
        ...
        assertEquals(expectedMessage, actualMessage, "Doit retourner un message qui contient 1  (tea), 1  (sugar) and 1 (stick)");
    }
    ...
    void testChocolateTwoSugar() {
        ...
        assertEquals(expectedMessage, actualMessage, "Doit retourner un message qui contient 1  (chocolate), 2  (sugar) and 1 (stick)");
    }
    ...
    void testExtraHotCoffeeNoSugarNotEnoughMoney() {
        ...
        String actualMessage = order.drinkMakerMessage();
        String expectedMessage = "Missing 20 cents";
        assertEquals(expectedMessage, actualMessage, "you re shot 20 cents");
    }
